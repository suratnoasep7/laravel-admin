<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-item">
            <a href="{{ route("admin.criterias.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/criterias") || request()->is("admin/criterias/*") ? "c-active" : "" }}">
                <i class="fa-fw fas fa-bookmark c-sidebar-nav-icon">

                </i>
                {{ trans('cruds.criteria.title') }}
            </a>
        </li>

        <li class="c-sidebar-nav-item">
            <a href="{{ route("admin.brand.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/brand") || request()->is("admin/brand/*") ? "c-active" : "" }}">
                <i class="fa-fw fas fa-bookmark c-sidebar-nav-icon">
