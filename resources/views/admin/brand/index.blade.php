                        ...
                        <tr data-entry-id="{{ $item->id }}">
                            ...
                            <td>
                                <div class="show-on-hover">
                                    ...
                                    @can('brand_show')
                                        <a class="btn btn-xs btn-outline-dark" href="{{ route('admin.brand.show', $item->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan

                                    @can('brand_edit')
                                        <a class="btn btn-xs btn-outline-dark" href="{{ route('admin.brand.edit', $item->id) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan

                                    @can('brand_delete')
                                        <form action="{{ route('admin.brand.destroy', $item->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
